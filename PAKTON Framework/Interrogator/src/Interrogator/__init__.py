"""
Description:
Interrogator package initialization that handles environment variable loading and provides the main Interrogator agent class for legal document interrogation.
...
def load_env_files():
    ...
    try:
        pkg_env_path = pkg_resources.resource_filename("Interrogator", ".env")
...
from .agent import Interrogator
