"""
Description:
AWS Bedrock model interface that provides configured ChatBedrock instances with proper authentication and parameter handling for the Interrogator agent.
