"""
Description:
Google Generative AI language model integration for the Researcher agent. Provides custom
ChatGoogleGenerativeAI implementations with support for Gemma models and proper message
conversion handling for different Google AI models.
...
def get_google_llm(model_id: str, **kwargs):
    ...
    if not api_key:
        logger.warning("GOOGLE_API_KEY environment variable is not set. Attempting to proceed anyway.")
