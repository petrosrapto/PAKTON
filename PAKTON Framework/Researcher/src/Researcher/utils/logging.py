"""
Description:
Logging configuration and management for the Researcher agent. Provides centralized
logging setup with configurable levels, file rotation, and formatting based on
YAML configuration settings using singleton pattern.
